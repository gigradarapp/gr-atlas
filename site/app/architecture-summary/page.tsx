...
export default function ArchitectureSummaryPage() {
  return <main className="atlas-summary">
    ...
    <section className="revenue-section">
      ...
      <div className="revenue-model" aria-label="Potential commercial model"><div><span>CUSTOMER</span><p>Operator-led family office, hospitality group, or entertainment entrepreneur</p><small>Atlas portfolio and operating workspace</small></div><div><span>OFFER</span><p>Evidence-linked portfolio, rights, risk, and activation decision support</p><small>Implementation fee + recurring software / intelligence fee</small></div><div><span>EXPANSION</span><p>Venue, festival, hotel, or brand using a white-labelled Buzo concierge or Original</p><small>Campaign / operations fee + performance share, licence, or royalty</small></div></div>
    ...
    <section className="section gtm-section">
      <div className="section-heading"><span>05 / GO-TO-MARKET STRATEGY</span><h2>Start where operating complexity already hurts.</h2></div>
      <div className="gtm-lead"><p><b>Initial wedge:</b> an operator-led family office or holding company with direct hospitality and entertainment exposure—not a passive family office. The buyer needs to coordinate assets, operators, rights, and decisions, not just receive a prettier portfolio report.</p><p>This is a GTM hypothesis to validate with real design partners. Atlas should grow from a committed workflow, not from dashboard speculation.</p></div>
      <div className="gtm-steps"><article><span>01</span><h3>Find a design partner</h3><p>Target a hospitality group, entertainment entrepreneur, or operator-led family office with active venue, event, or cultural-asset exposure.</p></article><article><span>02</span><h3>Sell one painful workflow</h3><p>Start with fragmented portfolio and rights reporting, or one high-stakes activation decision—not a broad platform sale.</p></article><article><span>03</span><h3>Prove operational value</h3><p>Show an evidence-linked view of holdings, obligations, risks, dependencies, and the decision trail that follows.</p></article><article><span>04</span><h3>Expand the relationship</h3><p>Move from paid implementation to recurring intelligence, concierge operations, licences, revenue share, and selective co-created IP.</p></article></div>
      <p className="gtm-foot">Distribution path: trusted operating relationships → scoped design-partner engagement → reusable Atlas workflow → broader portfolio and partner deployment.</p>
    </section>

    <section className="section comparison-section">
      <div className="section-heading"><span>06 / FAMILY OFFICE VS AGENTIC FAMILY OFFICE</span><h2>Same long horizon.<br /><em>Different operating cadence.</em></h2></div>
