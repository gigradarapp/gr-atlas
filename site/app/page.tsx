  ...
  return (
    <span className="brand-mark" aria-hidden="true">
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M17 8V56" stroke="currentColor" strokeWidth="5.5" strokeLinecap="round" />
        <path d="M19 8H34.5C45.2 8 51 13.2 51 21.1C51 28.9 45.2 33 35.5 33H19" stroke="currentColor" strokeWidth="5.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M19 33H37.3C47.7 33 53 38.1 53 45.2C53 52.3 47.7 56 37.3 56H19" stroke="currentColor" strokeWidth="5.5" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="35.5" cy="33" r="4.5" fill="currentColor" />
      </svg>
    </span>
  );
}
  ...
  return (
    <main>
      <nav className="topbar" aria-label="Primary navigation">
        ...
        <a className="nav-cta" href="#contact">Enter Atlas <span>↗</span></a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-copy">
          <p className="eyebrow"><span /> Agentic family-office model · Singapore</p>
          <h1>The operating system for <em>culture after dark.</em></h1>
          <p className="hero-intro">Atlas learns across partnerships, cultural rights, digital art and concierge technology—then turns evidence into decisions people can act on.</p>
        ...
        <div className="atlas-console-stage" id="atlas-live" aria-label="Illustrative Buzo Atlas intelligence artefact">
          ...
          <div className="atlas-console">
            <div className="console-top">
              <div className="console-name">Atlas / Cultural Intelligence</div>
      ...
      <section className="thesis" id="thesis">
        <p className="section-kicker">A NEW FAMILY-OFFICE MODEL</p>
        <h2>Not a dashboard for passive wealth.<br /><em>An active system for cultural advantage.</em></h2>
        <p>We apply long-horizon family-office discipline to relationship capital, cultural rights and proprietary technology—building assets that become stronger together.</p>
      </section>
